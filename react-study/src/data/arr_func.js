...
// 배열안의 요소들을 하나씩 접근함녀서 (반복실행) 수행후 return 기능
...
//forEach
arr.forEach((v)=>{  //매개변수에 arr 요소 한개씩 대임
    console.log('forEach : ' + v);
})

arr.map((item)=>{   //매개변수 1개 선언된 콜백함수 -> 배열의 요소 값 주입
...
// 3) find
let result10 = arr.find((value)=>{         ///못찾으면 undfined
                    return value ==20;
                })
...
// return
// 구조분해할당 (Destruturing Assignment)
